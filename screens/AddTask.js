...
import {addTaskToFB} from "../functions/FBDB";
...
export default function AddTask({route}) {
	...
	const [date, setDate] = useState(task == "Edit" ? data.time.toDate() : "");
	const [time, setTime] = useState(task == "Edit" ? data.time.toDate() : "");
