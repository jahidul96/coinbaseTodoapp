				...
				{voucher ? (
					<>
						<Text style={[styles.infoText, styles.voucherText]}>
							Congratulation's! you have been reemeded special
							voucher!,
						</Text>
						<Text style={[styles.infoText, styles.voucherText]}>
							your code is 567080.
						...
						<Text style={[styles.infoText, styles.voucherText]}>
							approach with code to get 10% discount
						</Text>
					</>
				) : (
					<Text style={styles.infoText}>
						Congratulation's! you have been productive today. Here
						is your reward! Take 5 minute Break!
					</Text>
				)}
			</View>
			<>
